...
if (isset($_POST['signupbtn']))
{
    ...
    $sql = "INSERT INTO feedback1(fName,lName,feedback,number) VALUES ('$fName','$lName','$feedback','$number')";
    mysqli_query($conn,$sql);
    echo"<center>feedback has been saved successfully!!!<br>thank you for feedback.<br>go to home page to surf more.</center>";
...
body{  background-color: red; /* For browsers that do not support gradients */
  background-image: linear-gradient(to bottom left,rgb(100,170,114) 20%,rgb(130,197,120) 10%, rgb(147,190,104) 20%, rgb(137,207,114) 20%, rgb(147,197,114) 20%);}
...
<div class="container">
      <h1 style="color:#8B8000 ">FEEDBACK FORM</h1>
      <p>Please fill this form for any FEEDBACK.</p>
      <hr>

    <label for="fName"><b style="font-size:20px;  color:#8B8000 ;">First Name : </b></label>
        <input type="text" placeholder="Enter first name" name="fName" id="fName" style="width:36%;font-size:20px" required>
    <label for="lName"><b style="font-size:20px;  color:#8B8000 ;">Last Name : </b></label>
        <input type="text" placeholder="Enter lastName" name="lName" id="lName" style="width:36%;font-size:20px" required>
<br>
    <label for="number"><b style="font-size:20px;  color:#8B8000 ;">Phone Number : </b></label>
    ...
    <label for="feedback"><b style="font-size:20px;  color:#8B8000 ;">FEEDBACK</b></label>
    <div>
        <br> <textarea name="feedback" placeholder="Enter feedback" id="feedback" cols="30" rows="10" style="width:30%;font-size:20px" required></textarea>
    </div>
    <br>
            <br>
            <div class="signupbtn" >
