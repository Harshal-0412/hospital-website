...
if (isset($_POST['signupbtn']))
{
    ...
    $vitamin = mysqli_real_escape_string($conn,$_POST['vitamin']);
    $plasma = mysqli_real_escape_string($conn,$_POST['plasma']);
    $timing = mysqli_real_escape_string($conn,$_POST['timing']);
    $sql = "INSERT INTO checkup(fName,lName,address,gender,DOB,number,DOAP,blood,glucose,thyroid,vitamin,plasma,timing) VALUES ('$fName','$lName','$address','$gender','$DOB','$number','$DOAP','$blood','$glucose','$thyroid','$vitamin','$plasma','$timing')";
...
body{  background-color: red; /* For browsers that do not support gradients */
  background-image: linear-gradient(to bottom right,rgb(243, 58, 106) 40%,rgb(255, 16, 240) 20%, rgb(227, 115, 131) 20%, rgb(201, 169, 166) 20%, rgb(248, 131, 121) 20%);}
</style>
<body bgcolor="pink">
<div class="sidenav">
...
<div class="modal-content">
    <form action="checkup1.php" method="post">
<div class="container">
      <h1 style="color:orchid">CHECKUP FORM</h1>
      <p>Please fill this form for routine report checkup.</p>
      <hr>

    <label for="fName"><b style="font-size:20px;  color:orchid;">First Name : </b></label>
        <input type="text" placeholder="Enter first name" name="fName" id="fName" style="width:36%;font-size:20px" required>
    <label for="lName"><b style="font-size:20px;  color:orchid;">Last Name : </b></label>
        <input type="text" placeholder="Enter lastName" name="lName" id="lName" style="width:36%;font-size:20px" required>
    <br>
       <b style="font-size:20px; color:orchid;"> Gender :</b> Male <input type="radio" name="gender" value="m" id="male"> Female <input type="radio" name="gender" value="f" id="female"> Others <input
            type="radio" name="gender"  value="o" id="other" required>
    <br><br>
    <label for="number"><b style="font-size:20px;  color:orchid;">Phone Number : </b></label>
    ...
    <label for="DOB"><b style="font-size:20px;  color:orchid;">DOB : </b></label>
        <input type="date" name="DOB" id="DOB" min="1901-01-01" max="2021-07-12" style="width:38%;font-size:20px" required>
    <br>
    <label for="address"><b style="font-size:20px;  color:orchid;">Address : </b></label>
    <div>
    ...
    <br>
            ...
            <div>
                <label for="specific area"><b style="font-size:20px;  color:orchid;">Specific Area : </b></label>
                <br>


                <input type="checkbox" name="blood" value="y" id="blood"> : BLOOD<br>
                <input type="checkbox" name="glucose" value="y" id="glucose"> : GLUCOSE<br>
                <input type="checkbox" name="thyroid" value="y" id="thyroid"> : THYROID<br>
                <input type="checkbox" name="vitamin" value="y" id="vitamin"> : VITAMIN B12<br>
                <input type="checkbox" name="plasma" value="y" id="plasma"> : PLASMA
            </div>
            <br>

                <label for="DOAP"><b style="font-size:20px;  color:orchid;">Date of Appointment : </b></label>
                <input type="date" name="DOAP" id="DOAP" min="2021-07-13" max="2021-07-29" style="width:40%;font-size:20px" required>
            <br>
            <b style="font-size:20px;  color:orchid;">timings for appointment : </b>
