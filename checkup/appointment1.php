...
if (isset($_POST['signupbtn']))
{
    ...
    $dental = mysqli_real_escape_string($conn,$_POST['dental']);
    $cardio = mysqli_real_escape_string($conn,$_POST['cardio']);
    $neuro = mysqli_real_escape_string($conn,$_POST['neuro']);
    $nephro = mysqli_real_escape_string($conn,$_POST['nephro']);
    $dermato = mysqli_real_escape_string($conn,$_POST['dermato']);
    $timing = mysqli_real_escape_string($conn,$_POST['timing']);
    $sql = "INSERT INTO appointment(fName,lName,address,gender,DOB,number,DOAP,dental,cardio,neuro,nephro,dermato,timing) VALUES ('$fName','$lName','$address','$gender','$DOB','$number','$DOAP','$dental','$cardio','$neuro','$nephro','$dermato','$timing')";
...
body{  background-color: red; /* For browsers that do not support gradients */
  background-image: linear-gradient(to bottom right,rgb(70,130,180) 40%,rgb(0,0,128) 10%, rgb(135,206,235) 20%, rgb(173,216,230) 20%, rgb(135,206,250) 20%);}
</style>
<body bgcolor=" #008CBA">
<div class="sidenav">
...
<div class="container">
      <h1 style="color:#20639B">APPOINTMENT FORM</h1>
      <p>Please fill this form for appointment.</p>
      <hr>

    <label for="fName"><b style="font-size:20px;  color:#008cba;">First Name : </b></label>
        <input type="text" placeholder="Enter first name" name="fName" id="fName" style="width:36%;font-size:20px" required>
    <label for="lName"><b style="font-size:20px;  color:#008cba;">Last Name : </b></label>
        <input type="text" placeholder="Enter lastName" name="lName" id="lName" style="width:36%;font-size:20px" required>
    <br>
       <b style="font-size:20px; color:#008cba;"> Gender :</b> Male <input type="radio" name="gender" value="m" id="male"> Female <input type="radio" name="gender" value="f" id="female"> Others <input
            type="radio" name="gender"  value="o" id="other" required>
    <br><br>
    <label for="number"><b style="font-size:20px;  color:#008cba;">Phone Number : </b></label>
        <input type="number" placeholder="Enter number" name="number" id="number" min="1000000000" max="9999999999" style="width:38%;font-size:20px" required>

    <label for="DOB"><b style="font-size:20px;  color:#008cba;">DOB : </b></label>
        <input type="date" name="DOB" id="DOB" min="1901-01-01" max="2021-07-01" style="width:30%;font-size:20px" required>
    <br>
    <label for="address"><b style="font-size:20px;  color:#008cba;">Address : </b></label>
    <div>
        <br> <textarea name="address" placeholder="Enter Address" id="address" cols="10" rows="10" style="width:30%;font-size:20px"></textarea>
    </div>

            <div>
                <label for="specific area"><b style="font-size:20px;  color:#008cba;"  required>Specific Area : (select these to book appointment in these fields)</b></label>
                <br>



                
                <input type="checkbox" name="dental" value="y" id="dental"> : DENTAL<br>
                <input type="checkbox" name="cardio" value="y" id="cardio"> : CARDIOLOGY<br>
                <input type="checkbox" name="neuro" value="y" id="neuro"> : NEUROLOGY<br>
                <input type="checkbox" name="nephro" value="y" id="nephro"> : NEPHROOLOGY<br>
                <input type="checkbox" name="dermato" value="y" id="dermato"> : DERMATOLOGY<br>


              </div>
            <br>
                <label for="DOAP"><b style="font-size:20px;  color:#008cba;">Date of Appointment : </b></label>
                <input type="date" name="DOAP" id="DOAP"  min="2021-07-15" max="2021-07-29" style="font-size:20px" required>
            <br>
            <b style="font-size:20px;  color:#008cba;">timings for appointment : </b>
            <table border="0" align="center">
              <tr>
                <td align="center" height="50" width="25"><input type="radio" name="timing" value="9-12" id="1"></td>
                <td align="center" height="50" width="200"> 9AM - 12PM</td>
              </tr>
              <tr>
                <td align="center" height="50" width="25"><input type="radio" name="timing" value="12-3" id="2"></td>
                <td align="center" height="50" width="200"> 12PM - 3PM</td>
              </tr>
              <tr>
                <td align="center" height="50" width="25"><input type="radio" name="timing" value="3-6" id="3" required></td>
                <td align="center" height="50" width="200"> 3PM - 6PM</td>
              </tr>
              <tr>
                <td align="center" height="50" width="25"><input type="radio" name="timing" value="6-9" id="4"></td>
                <td align="center" height="50" width="200"> 6PM - 9PM</td>
              </tr>
            </table>
            <br>
            <div class="signupbtn" >
