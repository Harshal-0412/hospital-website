...
if (isset($_POST['signupbtn']))
{
    ...
    $sql = "INSERT INTO covid1(fName,lName,aadhaar,address,gender,DOB,number,DOAP,timing) VALUES ('$fName','$lName','$aadhaar','$address','$gender','$DOB','$number','$DOAP','$timing')";
...
body{  background-color: red; /* For browsers that do not support gradients */
  background-image: linear-gradient(to bottom right,rgb(255,165,0) 40.5%,rgb(218,165,32) 15%, rgb(255,228,181) 20%, rgb(255,228,225) 20%, rgb(255,218,185) 20%);}
...
<div class="modal-content">
    <form action="covid1.php" method="post">
<div class="container">
      <h1 style="color:#FFAA33">COVID TEST FORM</h1>
      <p>Please fill this form for COVID TEST.</p>
      <hr>

    <label for="fName"><b style="font-size:20px;  color:#FFAA33;">First Name : </b></label>
        <input type="text" placeholder="Enter first name" name="fName" id="fName" style="width:36%;font-size:20px" required>
    <label for="lName"><b style="font-size:20px;  color:#FFAA33;">Last Name : </b></label>
        <input type="text" placeholder="Enter lastName" name="lName" id="lName" style="width:36%;font-size:20px" required>
    <br>
       <b style="font-size:20px; color:#FFAA33;"> Gender :</b> Male <input type="radio" name="gender" value="m" id="male"> Female <input type="radio" name="gender" value="f" id="female"> Others <input
            type="radio" name="gender"  value="o" id="other" required>
    <br><br>
    <label for="number"><b style="font-size:20px;  color:#FFAA33;">Phone Number : </b></label>
...
<label for="DOB"><b style="font-size:20px;  color:#FFAA33;">DOB : </b></label>
        <input type="date" name="DOB" id="DOB" min="1901-01-01" max="2021-07-14" style="width:36%;font-size:20px" required>
    <br>
    <br>
    <label for="aadhaar"><b style="font-size:20px;  color:#FFAA33;">Aadhaar number : </b></label>
        <input type="number" placeholder="Enter aadhaar" name="aadhaar" id="aadhaar" min="100000000000" max="999999999999" style="width:80%;font-size:20px" required>
    <br><br>
    <label for="address"><b style="font-size:20px;  color:#FFAA33;">Address : </b></label>
    <div>
    ...
    <br>
            ...
            <br>
                <label for="DOAP"><b style="font-size:20px;  color:#FFAA33;">Date of Appointment : </b></label>
                <input type="date" name="DOAP" id="DOAP"  min="2021-07-15" max="2021-07-29" style="width:40%;font-size:20px" required>

            <br><br>
            <b style="font-size:20px;  color:#FFAA33;">timings for appointment : </b>
            <table border="0" align="center">
              ...
              <tr>
                <td align="center" height="50" width="25"><input type="radio" name="timing" value="6-9" id="4" required></td>
