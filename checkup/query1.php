...
if (isset($_POST['signupbtn']))
{
    ...
    $sql = "INSERT INTO query1(fName,lName,query,number) VALUES ('$fName','$lName','$query','$number')";
    mysqli_query($conn,$sql);
    echo"<center>query has been saved successfully!!!<br>We will try to resolve it as soon as possible.<br>go to home page to surf more.</center>";
...
body{  background-color: red; /* For browsers that do not support gradients */
  background-image: linear-gradient(to bottom left,rgb(254,128,128) 20%,rgb(224,200,128) 10%, rgb(204,158,128) 20%, rgb(180,178,136) 20%, rgb(194,178,128) 20%);}
...
<div class="container">
      <h1 style="color:#FF5733 ">QUERY FORM</h1>
      <p>Please fill this form for any QUERY.</p>
      <hr>

    <label for="fName"><b style="font-size:20px;  color:#FF5733 ;">First Name : </b></label>
        <input type="text" placeholder="Enter first name" name="fName" id="fName" style="width:36%;font-size:20px" required>
    <label for="lName"><b style="font-size:20px;  color:#FF5733 ;">Last Name : </b></label>
        <input type="text" placeholder="Enter lastName" name="lName" id="lName" style="width:36%;font-size:20px" required>
<br>
    <label for="number"><b style="font-size:20px;  color:#FF5733 ;">Phone Number : </b></label>
    ...
    <label for="query"><b style="font-size:20px;  color:#FF5733 ;">QUERY</b></label>
    <div>
        <br> <textarea name="query" placeholder="Enter query" id="query" cols="30" rows="10" style="width:30%;font-size:20px" required></textarea>
    </div>
    <br>
            <br>
            <div class="signupbtn" >
